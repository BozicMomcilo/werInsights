  ...
  return (
    <div className="glass-panel p-6 mt-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="section-title">Activity & Engagement: Investor Interaction Metrics</h2>
      ...
      <div className="flex items-center space-x-6 mb-6 text-sm">
        <div className="glass-panel px-4 py-2">
          <span className="text-[#B0B3BA]">Average Clicks:</span>
          <span className="ml-2 text-[#FFE8AC] font-medium">{getAverageClicks()}</span>
        </div>
        <div className="glass-panel px-4 py-2">
          <span className="text-[#B0B3BA]">Top Feature:</span>
